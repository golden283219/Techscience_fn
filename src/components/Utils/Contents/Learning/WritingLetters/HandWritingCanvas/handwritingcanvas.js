...
const HandWritingCanvas = React.memo(forwardRef((props, ref)=>{
    ...
    function getImageUrl(imageName){
      return window.location.origin + "/assets/images/" + imageName
    }
    ...
    function onPointerUp(e){
        ...
        local.canvas.releasePointerCapture(e.pointerId);
        local.canvas.removeEventListener("pointermove", onPointerMove);
        local.canvas.removeEventListener("pointerup", onPointerUp);
        var w = [];
    ...
    return(
      <React.Fragment>
          <canvas ref={canvasRef} width={width} height={height} style={{cursor:"crosshair"}}             
            onPointerDown = {onPointerDown}
            onTouchStart={onTouchStart}
          >
          </canvas>
          <ControlBtns ref={controlBtnsRef} erase={erase} check={check} ref={controlBtnsRef}></ControlBtns>        
